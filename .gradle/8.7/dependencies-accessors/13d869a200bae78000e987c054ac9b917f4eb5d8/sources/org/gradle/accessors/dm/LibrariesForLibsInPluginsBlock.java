...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    public static class InsertKoinKoinAndroidxLibraryAccessors extends SubDependencyFactory {
        private final InsertKoinKoinAndroidxComposeLibraryAccessors laccForInsertKoinKoinAndroidxComposeLibraryAccessors = new InsertKoinKoinAndroidxComposeLibraryAccessors(owner);

        public InsertKoinKoinAndroidxLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>insert.koin.koin.androidx.compose</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public InsertKoinKoinAndroidxComposeLibraryAccessors getCompose() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForInsertKoinKoinAndroidxComposeLibraryAccessors;
        }
     ...
     */
    @Deprecated
    public static class InsertKoinKoinAndroidxComposeLibraryAccessors extends SubDependencyFactory {

        public InsertKoinKoinAndroidxComposeLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
        ...
        public Provider<MinimalExternalModuleDependency> getNavigation() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("insert.koin.koin.androidx.compose.navigation");
        }
     ...
     */
    @Deprecated
    public static class KoinAndroidxComposeLibraryAccessors extends SubDependencyFactory {
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>koinAndroidxComposeNavigation</b> with value <b>4.0.0-RC2</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>lifecycleViewmodelCompose</b> with value <b>2.8.5</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class KoinVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>koin.bom</b> with value <b>3.5.6</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
